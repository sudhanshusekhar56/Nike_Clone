...
function ys() {
  if (Qt) {
    var e = Qt,
      t = Kt;
    if (((Kt = Qt = null), Ko(e), t)) for (e = 0; e < t.length; e++) Ko(t[e]);
  }
}
function xs(e, t) {
  return e(t);
...
function iu() {
  Nn && (Nn.detachEvent("onpropertychange", Bs), (Fn = Nn = null));
}
function Bs(e) {
  if (e.propertyName === "value" && ll(Fn)) {
    var t = [];
    As(t, Fn, e, Gi(e)), ks(Df, t);
  }
}
function If(e, t, n) {
  e === "focusin"
    ? (iu(), (Nn = t), (Fn = n), Nn.attachEvent("onpropertychange", Bs))
    : e === "focusout" && iu();
}
function Uf(e) {
...
function mt() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Cs(Zi, mt), l);
    } finally {
      (O = t), (Il = !1);
    }
  }
...
function Ni(e, t, n, r) {
  var l = e.stateNode;
  (l.props = n), (l.state = e.memoizedState), (l.refs = oa), po(e);
  var i = t.contextType;
  typeof i == "object" && i !== null
    ? (l.context = Ne(i))
...
function Ca(e, t, n) {
  return _t & 21
    ? (Oe(n, t) || ((n = Ps()), (A.lanes |= n), (jt |= n), (e.baseState = !0)),
      t)
  ...
  od = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        Cr(4194308, 4, ka.bind(null, t, e), n)
      );
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Qn(9, ma.bind(null, r, i, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function Tu(e, t, n, r, l) {
  ...
  if ((Xt(t, l), t.stateNode === null))
    _r(e, t), ua(t, n, r), Ni(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      u = t.memoizedProps;
    o.props = u;
...
function Va(e) {
  ...
  t !== null && ((e.alternate = null), Va(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Fe], delete t[An], delete t[yi], delete t[qf], delete t[bf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
xs = _o;
ws = Pt;
var Rd = { usingClientEntryPoint: !1, Events: [Jn, It, ol, gs, ys, _o] },
  vn = {
...
const Mo = "/assets/arrow-right-bda17713.svg",
  Dd = "/assets/copyright-sign-980e3d21.svg",
  Fd = "/assets/facebook-ff6684c8.svg",
  Id = "/assets/hamburger-4c58344a.svg",
  Ud = "/assets/instagram-11886854.svg",
  $d = "/assets/support-f3742739.svg",
  Ad = "/assets/shield-tick-ddabc82c.svg",
  lc = "/assets/star-b33c0941.svg",
  Vd = "/assets/truck-fast-c70b3352.svg",
  Bd = "/assets/twitter-c7241c8d.svg",
  ic = "/assets/big-shoe1-0c574e3f.png",
  Hd = "/assets/big-shoe2-84852328.png",
  Wd = "/assets/big-shoe3-f8fa095d.png",
  Qd = "/assets/customer1-68e0c3c8.jpeg",
  Kd = "/assets/customer2-b505f82b.svg",
  ...
  ip = [
    { thumbnail: tp, bigShoe: ic },
    { thumbnail: np, bigShoe: Hd },
    { thumbnail: rp, bigShoe: Wd },
  ],
  op = [
  ...
  up = [
    { imgURL: Zd, name: "Nike Air Jordan-01", price: "$200.20" },
    { imgURL: Jd, name: "Nike Air Jordan-10", price: "$210.20" },
    { imgURL: qd, name: "Nike Air Jordan-100", price: "$220.20" },
    { imgURL: bd, name: "Nike Air Jordan-001", price: "$230.20" },
  ],
  sp = [
    {
      imgURL: Vd,
  ...
  fp = [
    { src: Fd, alt: "facebook logo" },
    { src: Bd, alt: "twitter logo" },
    { src: Ud, alt: "instagram logo" },
  ],
  Yn = ({
    label: e,
    iconUrl: t,
  ...
  dp = ({ imgURL: e, changeBigShoeImage: t, bigShoeImg: n }) => {
    const r = () => {
  ...
  pp = () =>
    p.jsx("header", {
      className: "padding-x py-8 relative w-full",
      children: p.jsxs("nav", {
        ...
        children: [
          ...
          p.jsxs("ul", {
            className: "flex justify-center align-center gap-16 max-lg:hidden",
            children: [
              lp.map((e) =>
                p.jsx(
                  "li",
                  {
                    children: p.jsx("a", {
                      href: e.href,
                      className:
                        "font-montsract landing-normal text-lg text-slate-grey",
                      children: e.label,
                    }),
                  },
                  e.label
  ...
  mp = ({ imgURL: e, customerName: t, rating: n, feedback: r }) =>
    p.jsxs("div", {
      ...
      children: [
        ...
        p.jsx("p", {
          className: "mt-2 font-palanquin text-3xl text-center font-bold",
          children: t,
        }),
      ],
    }),
  hp = () => {
    ...
    return p.jsxs("section", {
      id: "home",
      className:
        "w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container min-xl: pl-10 pr-10",
      children: [
        p.jsxs("div", {
          className:
        ...
        p.jsxs("div", {
          className:
            "relative flex-1 flex justify-center rounded-3xl items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center",
          children: [
            p.jsx("img", {
              src: e,
              alt: "shoe colletion",
  ...
  vp = ({ imgURL: e, name: t, price: n }) =>
    p.jsxs("div", {
      className: "flex flex-1 flex-col w-full max-sm:w-full sm:items-center",
      children: [
        p.jsx("img", { src: e, alt: t, className: "w-[282px] h-[282px]" }),
        p.jsxs("div", {
      ...
      children: [
        p.jsxs("div", {
          ...
          children: [
            ...
            p.jsx("p", {
              className: "lg:max-w-lg mt-2 font-montserrat text-slate-grey",
              children:
                "Experience top notch quality and style with our sought-after selection. Discover a world of comfort, dsign and value.",
            }),
          ],
        }),
        p.jsx("div", {
          ...
          children: up.map((e) => p.jsx(vp, { ...e }, e.name)),
        }),
      ],
    }),
  yp = () =>
      ...
      children: [
        p.jsxs("div", {
          ...
          children: [
            p.jsxs("h2", {
              className:
                "font-palanquin capitalize text-4xl lg:max-w-lg font-bold",
              children: [
                "We Provide You",
                p.jsx("span", {
                  className: "text-coral-red",
            ...
            p.jsx("div", {
              className: "mt-11",
              children: p.jsx(Yn, { label: "View details", iconUrl: Mo }),
            }),
          ],
        }),
        p.jsx("div", {
  ...
  wp = () =>
    p.jsx("section", {
      ...
      children: sp.map((e) => p.jsx(xp, { ...e }, e.label)),
    }),
  kp = () =>
    p.jsxs("section", {
      className:
  ...
  Sp = () =>
    p.jsxs("section", {
      ...
      children: [
        p.jsxs("h3", {
          className: "text-4xl font-palanquin text-center font-bold",
          children: [
            "What Our ",
            p.jsx("span", {
              className: "text-coral-red",
        ...
        p.jsx("p", {
          className: "info-text m-auto mt-5 max-w-lg text-center",
          children:
  ...
  Ep = () =>
    p.jsxs("section", {
      ...
      children: [
        p.jsxs("h3", {
          className: "text-4xl font-bold leading-[68px] lg: font-palanquin",
          children: [
            "Sign Up from ",
            p.jsx("span", { className: "text-coral-red", children: "Updates" }),
            " and Newsletter",
          ],
        }),
        p.jsxs("div", {
          ...
          children: [
            ...
            p.jsx("div", {
              ...
              children: p.jsx(Yn, { label: "Sign Up", fullWidth: !0 }),
            }),
          ],
        }),
      ],
  ...
  Np = () =>
    p.jsxs("footer", {
      ...
      children: [
        p.jsxs("div", {
          className:
            "flex justify-between items-start gap-20 flex-wrap max-lg:fkex-col",
          children: [
            p.jsxs("div", {
              ...
              children: [
                ...
                p.jsx("p", {
                  className:
                    "text-base leading-7 font-montserrat text-white-400 sm:max-w-sm ",
                  children:
                    "Get shoes ready from the nearest Nike store. Find Your Perfect Size In Store.",
                }),
                p.jsx("div", {
                  className: "flex items-center gap-5 mat-8",
                  children: fp.map((e) =>
                    p.jsx("div", {
                      className:
            ...
            p.jsx("div", {
              className:
                "flex flex-1 justify-between lg:gap-10 gap-20 flwx-wrap",
              children: cp.map((e) =>
                p.jsxs(
                  "div",
                  {
                    children: [
                      p.jsx("h4", {
                        className:
                          "text-white font-montserrat text-2xl leading-normal font-md mb-6",
                        children: e.title,
                      }),
                      p.jsx("ul", {
                        children: e.links.map((t) =>
                          p.jsx("li", {
                            className:
                              "mt-3 text-white-400 font-montserract text-base leading-normal hover:text-slate-grey cursor-pointer",
                            children: p.jsx("a", {
                              href: t.link,
                              children: t.name,
                            }),
        ...
        p.jsxs("div", {
          ...
          children: [
            p.jsxs("div", {
              className:
                "flex flex-1 jsutify-start items-center gap-2 font-montserrat cursor-pointer",
              children: [
                p.jsx("img", {
                  src: Dd,
                  alt: "copyright",
  ...
  Cp = () =>
    p.jsxs("main", {
      ...
      children: [
        p.jsx(pp, {}),
        p.jsx("section", {
          className: "padding-1 padding-b",
          children: p.jsx(hp, {}),
        }),
        p.jsx("section", { className: "padding", children: p.jsx(gp, {}) }),
        p.jsx("section", { className: "padding", children: p.jsx(yp, {}) }),
        p.jsx("section", {
          className: "padding-x py-10",
          children: p.jsx(wp, {}),
        }),
        p.jsx("section", { className: "padding", children: p.jsx(kp, {}) }),
        p.jsx("section", {
        ...
        p.jsx("section", {
          className: "padding-x padding-t pb-8 bg-black text-white",
          children: p.jsx(Np, {}),
        }),
      ],
    });
Kl.createRoot(document.getElementById("root")).render(
  p.jsx(Ec.StrictMode, { children: p.jsx(Cp, {}) })
);
